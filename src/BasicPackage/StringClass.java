...
public class StringClass {
    public static void main(String[] args){
        ...
        String modified = original.concat("sharad");
        System.out.println(original + " " + modified);
        original = "another one";
        // original[3] = 's';  changes not works here
        System.out.println(original + " " + modified);
        System.out.println("\n" + "=".repeat(60) + "\n");
        ...
        // getting character at any index....
        ...
        // compare gives us either positive, zero or negative.
        ...
        System.out.println("String to char array: " + Arrays.toString("Hello".toCharArray()));
        System.out.println("\n" + "=".repeat(60) + "\n");
    ...
    // this is second way we can build the string
    ...
    public static void demonstrateStringBuffer(){
        ...
        System.out.println("Initial StringBuffer: " + sf);

        sf.append(" is");
        sf.append(" awesome!");
        System.out.println("After appends: " + sf);
        System.out.println("Capacity: " + sf.capacity());

        // Insert operation
        sf.insert(4, " Programming");
        System.out.println("After insert: " + sf);
        System.out.println("Capacity: " + sf.capacity());

        // Replace operation
        sf.replace(17, 24, "great");
